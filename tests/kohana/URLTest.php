...
class Kohana_URLTest extends Unittest_TestCase
{
	...
	public function provider_base()
	{
		...
		return [
			...
			// Test for automatic protocol based on config
			[TRUE, TRUE, 'https://example.com/kohana/index.php/', []],
			[TRUE, TRUE, 'http://example.com/kohana/index.php/', ['application.ssl_active' => FALSE]],
			[TRUE, TRUE, 'https://example.com/kohana/index.php/', ['application.ssl_active' => TRUE]],
			...
			[
				...
				['HTTP_HOST' => 'example.com', 'SERVER_NAME' => 'example.org'],
			],
