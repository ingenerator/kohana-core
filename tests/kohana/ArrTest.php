...
class Kohana_ArrTest extends Unittest_TestCase
{
	...
	public function provider_path()
	{
		...
		return [
			...
			// ArrayObject
			[$array['kohana'], $array_object, 'kohana'],
			[$array['foobar']['definition'], $array_object, 'foobar.definition'],
			[$array['users'][1]['name'], $array_object, 'users.1.name'],
			[NULL, $array_object, 'foobar.alternatives', NULL],
			[['far', 'wide'], $array_object, 'cheese.origins', ['far', 'wide']],
		];
	}
