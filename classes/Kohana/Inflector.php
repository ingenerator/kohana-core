...
class Kohana_Inflector {
	...
	{
		return \strtolower(\preg_replace('/([a-z])([A-Z])/', '$1'.$sep.'$2', \trim($str)));
	}
	...
	{
		return \preg_replace('/\s+/', '_', \trim($str));
	}
